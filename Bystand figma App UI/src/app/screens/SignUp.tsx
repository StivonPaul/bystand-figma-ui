      ...
      <div className="flex-1 px-6 py-12">
        <div className="max-w-sm mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join ByStand today</p>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl font-medium shadow-lg disabled:opacity-60 transition-opacity"
            >
          ...
          <div className="mt-6 text-center">
            ...
            <button onClick={() => navigate("/sign-in")} className="text-blue-600 font-medium text-sm">
              Sign In
            </button>
          </div>
        </div>
